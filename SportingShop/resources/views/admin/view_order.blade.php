        ...
        <table class="table table-striped b-t b-light">
            ...
            <tbody>
                ...
                <tr  class="color_qty_{{$detail->product_id}}">
                    ...
                    <td>{{$detail->product->product_quanty}}</td>                
                    <td colspan="1">
                        ...
                        <input type="hidden" name="order_qty_storage" class="order_qty_storage_{{$detail->product_id}}" value="{{$detail->product->product_quanty}}">
                        @if($order_status != 2)
