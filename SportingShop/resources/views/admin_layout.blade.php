...
<body>
            ...
            <div class="top-nav clearfix">
                ...
                <ul class="nav pull-right top-menu">
                    ...
                    <li class="dropdown">
                        ...
                        <img alt="" src="{{asset('public/backend/images/Capture.PNG')}}">
                        <span class="username">
                        <?php
                    ...
                    <ul class="sidebar-menu" id="nav-accordion">
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                ...
                                <li><a href="{{URL::to('/all-category-product')}}">Liệ kê danh mục sản phẩm</a></li>
                            </ul>
                        </li>
                        <li class="sub-menu">
                            <a href="javascript:;">
                            ...
                            <ul class="sub">
                                ...
                                <li><a href="{{URL::to('/all-brand-product')}}">Liệ kê thương hiệu sản phẩm</a></li>
                            </ul>
                        </li>
                        <li class="sub-menu">
                            <a href="javascript:;">
                            ...
                            <ul class="sub">
                                ...
                                <li><a href="{{URL::to('/all-product')}}">Liệ kê sản phẩm</a></li>
                            </ul>
                        </li>
    ...
    <!-- click update so luong don hang -->
    <script type="text/javascript">
